...
var ASM_CONSTS = {
  3166468: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3166523: ($0) => { performance.now = function() { return $0; }; },  
 3166571: ($0) => { performance.now = function() { return $0; }; },  
 3166619: () => { performance.now = Module['emscripten_get_now_backup']; }
};
