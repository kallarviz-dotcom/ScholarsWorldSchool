...
var ASM_CONSTS = {
  3166532: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3166587: ($0) => { performance.now = function() { return $0; }; },  
 3166635: ($0) => { performance.now = function() { return $0; }; },  
 3166683: () => { performance.now = Module['emscripten_get_now_backup']; }
};
